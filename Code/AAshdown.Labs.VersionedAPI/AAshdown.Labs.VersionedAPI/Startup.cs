using AAshdown.Labs.VersionedAPI.ApiDocs;
...
namespace AAshdown.Labs.VersionedAPI
{
    public class Startup
    {
        ...
        { 
            ...
            // Add versioned api support to pipeline
            app.UseApiVersioning();
            app.UseSwaggerGenerationUI(apiDescription, Configuration);
